...
I'm a **Freelance Data Analyst** with a background in **Mathematics (Probability & Statistics)** and **4 years of corporate experience** at **Lloyds Banking Group and BAE Systems**. Skilled in **Python, SQL, Tableau and ETL solutions**, with a strong ability to **extract insights from data**, apply them to business use cases, and **drive data-driven decisions**. Having transferred from corporate roles to freelancing, great focus is placed on building a portfolio of projects focussing on **data modelling, visualisation, and AI-driven analysis** to uncover meaningful patterns and deliver actionable insights. With expertise in both **technical analysis and stakeholder communication**, I bridge the gap between data and business understanding, ensuring findings are presented **clearly, transparently, and impactfully** across teams.

🚀 **Currently Working On:**  
- **Helping businesses make data-driven decisions** through **freelance projects and consulting**
...
- **Upskilling in cloud computing (Microsoft Azure, AWS**) to enhance data storage and automation workflows
...
![Excel](https://img.shields.io/badge/Excel-217346?style=flat&logo=microsoftexcel&logoColor=white)  ![Tableau](https://img.shields.io/badge/Tableau-E97627?style=flat&logo=tableau&logoColor=white)  ![Power BI](https://img.shields.io/badge/PowerBI-F2C811?style=flat&logo=powerbi&logoColor=black)  

### **⚙️ Data Engineering & Machine Learning**  
![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat&logo=pandas&logoColor=white)  ![Scikit-Learn](https://img.shields.io/badge/Scikit--Learn-F7931E?style=flat&logo=scikitlearn&logoColor=white)  ![ETL](https://img.shields.io/badge/ETL-0A66C2?style=flat&logo=data&logoColor=white)  
...
![AWS](https://img.shields.io/badge/AWS-FF9900?style=flat&logo=amazonaws&logoColor=white)  ![Azure](https://img.shields.io/badge/Azure-0078D4?style=flat&logo=microsoftazure&logoColor=white) 
 ![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)  ![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=flat&logo=jupyter&logoColor=white)  
